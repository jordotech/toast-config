...
class RevenueCenter(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None, description=None):
        """
        RevenueCenter - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this RevenueCenter.
        The GUID maintained by the Toast POS.

        :return: The guid of this RevenueCenter.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this RevenueCenter.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this RevenueCenter.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this RevenueCenter.
        The type of object this is.

        :return: The entity_type of this RevenueCenter.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this RevenueCenter.
        The type of object this is.

        :param entity_type: The entity_type of this RevenueCenter.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this RevenueCenter.
        The name of this revenue center.

        :return: The name of this RevenueCenter.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this RevenueCenter.
        The name of this revenue center.

        :param name: The name of this RevenueCenter.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this RevenueCenter.
        The description of this revenue center.

        :return: The description of this RevenueCenter.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this RevenueCenter.
        The description of this revenue center.

        :param description: The description of this RevenueCenter.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RevenueCenter):
            return False
