...
class PreModifierGroup(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None, is_default=None):
        """
        PreModifierGroup - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this PreModifierGroup.
        The GUID maintained by the Toast POS.

        :return: The guid of this PreModifierGroup.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this PreModifierGroup.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this PreModifierGroup.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this PreModifierGroup.
        The type of object this is.

        :return: The entity_type of this PreModifierGroup.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this PreModifierGroup.
        The type of object this is.

        :param entity_type: The entity_type of this PreModifierGroup.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this PreModifierGroup.
        The name of the pre modifier that appears in the Toast POS.

        :return: The name of this PreModifierGroup.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this PreModifierGroup.
        The name of the pre modifier that appears in the Toast POS.

        :param name: The name of this PreModifierGroup.
        :type: str
        """
    ...
    def is_default(self):
        """
        Gets the is_default of this PreModifierGroup.
        ...
        :return: The is_default of this PreModifierGroup.
        :rtype: bool
        """
    ...
    def is_default(self, is_default):
        """
        Sets the is_default of this PreModifierGroup.
        True if this PreModifierGroup is set as the default Group. Only a single PreModifierGroup can be set as default at one time. 

        :param is_default: The is_default of this PreModifierGroup.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PreModifierGroup):
            return False
