...
class NoSaleReason(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None):
        """
        NoSaleReason - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this NoSaleReason.
        The GUID maintained by the Toast POS.

        :return: The guid of this NoSaleReason.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this NoSaleReason.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this NoSaleReason.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this NoSaleReason.
        The type of object this is.

        :return: The entity_type of this NoSaleReason.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this NoSaleReason.
        The type of object this is.

        :param entity_type: The entity_type of this NoSaleReason.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this NoSaleReason.
        The name of the no sale reason that appears in the Toast POS.

        :return: The name of this NoSaleReason.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this NoSaleReason.
        The name of the no sale reason that appears in the Toast POS.

        :param name: The name of this NoSaleReason.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NoSaleReason):
            return False
