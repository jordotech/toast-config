...
class SalesCategory(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None):
        """
        SalesCategory - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this SalesCategory.
        The GUID maintained by the Toast POS.

        :return: The guid of this SalesCategory.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this SalesCategory.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this SalesCategory.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this SalesCategory.
        The type of object this is.

        :return: The entity_type of this SalesCategory.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this SalesCategory.
        The type of object this is.

        :param entity_type: The entity_type of this SalesCategory.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this SalesCategory.
        The name of this sales category.

        :return: The name of this SalesCategory.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this SalesCategory.
        The name of this sales category.

        :param name: The name of this SalesCategory.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SalesCategory):
            return False
