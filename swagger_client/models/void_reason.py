...
class VoidReason(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None):
        """
        VoidReason - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this VoidReason.
        The GUID maintained by the Toast POS.

        :return: The guid of this VoidReason.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this VoidReason.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this VoidReason.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this VoidReason.
        The type of object this is.

        :return: The entity_type of this VoidReason.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this VoidReason.
        The type of object this is.

        :param entity_type: The entity_type of this VoidReason.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this VoidReason.
        The name of this void reason.

        :return: The name of this VoidReason.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this VoidReason.
        The name of this void reason.

        :param name: The name of this VoidReason.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VoidReason):
            return False
