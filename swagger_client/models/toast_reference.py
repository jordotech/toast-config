...
class ToastReference(object):
    ...
    def __init__(self, guid=None, entity_type=None):
        """
        ToastReference - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this ToastReference.
        The GUID maintained by the Toast POS.

        :return: The guid of this ToastReference.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this ToastReference.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this ToastReference.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this ToastReference.
        The type of object this is.

        :return: The entity_type of this ToastReference.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this ToastReference.
        The type of object this is.

        :param entity_type: The entity_type of this ToastReference.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ToastReference):
            return False
