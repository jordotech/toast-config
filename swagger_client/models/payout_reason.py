...
class PayoutReason(object):
    ...
    def __init__(self, guid=None, entity_type=None, name=None):
        """
        PayoutReason - a model defined in Swagger
        """
    ...
    def guid(self):
        """
        Gets the guid of this PayoutReason.
        The GUID maintained by the Toast POS.

        :return: The guid of this PayoutReason.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this PayoutReason.
        The GUID maintained by the Toast POS.

        :param guid: The guid of this PayoutReason.
        :type: str
        """
        if guid is None:
    ...
    def entity_type(self):
        """
        Gets the entity_type of this PayoutReason.
        The type of object this is.

        :return: The entity_type of this PayoutReason.
        :rtype: str
        """
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this PayoutReason.
        The type of object this is.

        :param entity_type: The entity_type of this PayoutReason.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this PayoutReason.
        The short name of this payout reason.

        :return: The name of this PayoutReason.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this PayoutReason.
        The short name of this payout reason.

        :param name: The name of this PayoutReason.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PayoutReason):
            return False
